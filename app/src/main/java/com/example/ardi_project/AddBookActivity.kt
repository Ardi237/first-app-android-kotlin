...
class BookDetailActivity : AppCompatActivity() {
    ...
    private fun loadBookDetails() {
        ...
        if (book != null) {
            ...
            Log.d(
                "DatabaseHelper",
                "Retrieved book: id=${book.id}, nama=${book.nama}, panggilan=${book.namaPanggilan}, email=${book.email}, alamat=${book.alamat}, tglLahir=${book.tanggalLahir}, noHp=${book.noHp}"
            )
        } else {
            Log.e("DEBUG_DETAIL", "Book ID $bookId not found")
        }
    }

...
import com.example.ardi_project.adapters.NotesAdapter
        ...
        RetrofitClient.instance.getNotes().enqueue(object : Callback<List<Note>> {
            override fun onResponse(call: Call<List<Note>>, response: Response<List<Note>>) {
                if (response.isSuccessful) {
                    ...
                    Toast.makeText(this@NotesActivity, "Error: ${response.code()} - $errorBody", Toast.LENGTH_LONG).show()
                }
            }

            override fun onFailure(call: Call<List<Note>>, t: Throwable) {
                Log.e("API_ERROR", "Error: ${t.message}", t)
                Toast.makeText(this@NotesActivity, "Koneksi gagal: ${t.message}", Toast.LENGTH_LONG).show()
            }
        })
    }
        ...
        notesAdapter = NotesAdapter(
            ...
            onItemClick = { note ->
                ...
                val intent = Intent(this, DetailNoteActivity::class.java).apply {
                    ...
                    putExtra("note_content", note.body)
                }
        ...
        RetrofitClient.instance.deleteNote(note.id).enqueue(object : Callback<Void> {
            override fun onResponse(call: Call<Void>, response: Response<Void>) {
                if (response.isSuccessful) {
                    ...
                    Toast.makeText(this@NotesActivity, "Error: ${response.code()}", Toast.LENGTH_SHORT).show()
                }
            }

            override fun onFailure(call: Call<Void>, t: Throwable) {
                Toast.makeText(this@NotesActivity, "Gagal menghapus catatan", Toast.LENGTH_SHORT).show()
            }
        })
    }
        ...
        RetrofitClient.instance.updateNote(noteId, title, content)
            .enqueue(object : Callback<Note> {
                override fun onResponse(call: Call<Note>, response: Response<Note>) {
                    if (response.isSuccessful) {
                        Toast.makeText(this@DetailNoteActivity, "Catatan berhasil diupdate", Toast.LENGTH_SHORT).show()
                        finish()
                    } else {
                        Toast.makeText(this@DetailNoteActivity, "Error: ${response.code()}", Toast.LENGTH_SHORT).show()
                    }
                }

                override fun onFailure(call: Call<Note>, t: Throwable) {
                    Toast.makeText(this@DetailNoteActivity, "Gagal mengupdate catatan", Toast.LENGTH_SHORT).show()
                }
            })
    }
    ...
    private fun deleteNote() {
        RetrofitClient.instance.deleteNote(noteId)
            .enqueue(object : Callback<Void> {
                override fun onResponse(call: Call<Void>, response: Response<Void>) {
                    if (response.isSuccessful) {
                        Toast.makeText(this@DetailNoteActivity, "Catatan berhasil dihapus", Toast.LENGTH_SHORT).show()
                        finish()
                    } else {
                        Toast.makeText(this@DetailNoteActivity, "Error: ${response.code()}", Toast.LENGTH_SHORT).show()
                    }
                ...
                override fun onFailure(call: Call<Void>, t: Throwable) {
                    Toast.makeText(this@DetailNoteActivity, "Gagal menghapus catatan", Toast.LENGTH_SHORT).show()
                }
            })
    }
}